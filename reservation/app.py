...
def book_table(restaurant_name, num_of_seats):
    ...
    if available_seats >= num_of_seats:
        ...
        return f"Table booked at {restaurant_name} for {num_of_seats} seats."
    else:
        return f"Sorry, {restaurant_name} doesn't have enough available seats for {num_of_seats} people."
